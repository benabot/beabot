...
export const projects: Project[] = [
  ...
  {
    id: 'raffinage-microdatas',
    title: 'Jeu de raffinage de microdatas',
    subtitle: 'Jeu en JavaScript sur les nombres premiers',
    image: '/img/raffinage.webp',
    url: 'https://raffinage-microdatas.netlify.app/',
    featured: false,
    tags: ['WebDesign', 'Javascript'],
    context: 'Jeu en JavaScript sur les nombres premiers',
    role: '',
    stack: ['JavaScript'],
    githubLink: 'https://github.com/benabot/raffinage',
  },
  {
    id: 'aave',
    title: 'AAVE',
