      ...
      <section class="app-hero">
        <div class="app-hero__content">
          ...
          <div class="app-actions">
            <a
              v-if="focusOneContent.appStoreUrl"
              :href="focusOneContent.appStoreUrl"
      ...
      >
        ...
        >
          <div class="app-download-cta__copy">
            <h2 id="focus-download-title">Essayez FocusOne gratuitement</h2>
            <p>
              Téléchargez FocusOne sur l’App Store et commencez gratuitement
              avec une habitude active, le suivi quotidien, des rappels simples,
              les widgets de base et les statistiques essentielles. Premium
              débloque notamment l’historique complet, les stats avancées, les
              widgets moyen et grand, les archives et la personnalisation, avec
              un abonnement annuel à 14,99 € ou un achat unique à 39,99 €.
            </p>
          </div>
          <a
            :href="focusOneContent.appStoreUrl"
