<template>
  <main class="app-page">
    <div class="app-shell">
      ...
      <section class="app-panel" aria-labelledby="meeting-overview-title">
      ...
      <section class="app-panel" aria-labelledby="meeting-details-title">
      ...
      <section class="app-panel" aria-labelledby="meeting-faq-title">
        <h2 id="meeting-faq-title">FAQ</h2>
        <AppFaqList :items="meetingModeContent.faq" />
      </section>

      <section class="app-panel" aria-labelledby="meeting-legal-title">
